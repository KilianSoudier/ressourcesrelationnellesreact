            ...
            <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
              ...
              {/* //<!-- Logo --> */}
                <div class="flex-shrink-0 flex items-center">
                    <a href="/" class="text-white text-xl font-bold">Ressources Relationnelles</a>
                    <Link to="/profil/Kilian"> test </Link>
                </div>
                ...
                <div class="absolute inset-y-0 right-0 flex items-center sm:hidden">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class='hidden' fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
